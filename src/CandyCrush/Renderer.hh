...
public:
	...
	void Push(const ObjectID &objectID, const Transform &transform, double angle, SDL_Point* center, SDL_RendererFlip flip)
	{
		//Render to screen
		SDL_RenderCopyEx(m_SDLRenderer, m_textureData[objectID], NULL, &transform.rect, angle, center, flip);
	}
